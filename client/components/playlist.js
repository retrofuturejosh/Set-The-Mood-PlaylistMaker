...
export class Playlist extends Component {
  ...
  _handleKeyDown(e) {
    if (e.key === "ArrowRight" || e.key === "ArrowLeft") {
      ...
      if (
        currentToggle === this.props.playlist.playlistArr.length - 1 &&
        e.key === "ArrowRight"
      ) {
        currentToggle = -1;
      }
      this.setState({
        videoToggle:
          e.key === "ArrowRight" ? currentToggle + 1 : currentToggle - 1
      });
    }
    if (e.code === "Space") {
      e.preventDefault();
  ...
  exportPlaylist() {
    ...
    fetch(url, {
      method: "POST",
      body: JSON.stringify({
        name: `VIBEZ playlist: ${this.props.chosenTrack.artist} - ${
          ...
          <div id="player-wrapper">
            ...
            <div id="player">
              <div
                ...
                onClick={e => {
                  this.state.videoToggle > 0
                    ...
                    : this.setState({
                        videoToggle: this.props.playlist.playlistArr.length - 1
                      });
                }}
              >
                prev
              ...
              <div id="player-center">
                {`${
                  this.props.playlist.playlistArr[+this.state.videoToggle]
                    .artist
                } - ${
                  this.props.playlist.playlistArr[+this.state.videoToggle].name
                }`}
                <YouTube
                  playing
                  videoId={
              ...
              <div
                ...
                onClick={e => {
                  ...
                  this.props.playlist.playlistArr.length - 1
            ...
            <tbody>
              ...
              {this.props.playlist.playlistArr.map((song, i) => {
                return (
                  <tr key={`${i}div`}>
                    {song.spotifyID ? (
                      <div key={`spotify${i}`} className="spotify-image">
                        ...
                        <div className="spotify-controls">
                          {song.preview ? (
                            <div>
                              <img
                                ...
                                src={
                                  +this.state.playingPreview === i
                                    ? "/pause-button.png"
                                    : "/play-button.png"
                                }
                                onClick={e => {
                                  this.playSong(e, song.name);
                                }}
                              />
                            </div>
                          ) : (
                          ...
                          <div>
                            <img
                              ...
                              onClick={e => {
                                window.open(song.spotifyURL.spotify);
                              }}
                            />
                          </div>
                        </div>
                    ...
                    <th
                      className={
                        i === +this.state.videoToggle ? "leftselect" : "left"
                      }
                    ...
                    <th
                      ...
                      onClick={e => {
                        this.moveBack(e, i),
                          this.props.removeTrack(e, this.props.playlist, i);
                      }}
                    />
                  </tr>
                );
